...
pip install https://github.com/jhennies/squirrel/archive/refs/tags/0.4.13.tar.gz
pip install https://github.com/jhennies/AMST2/archive/refs/tags/0.3.23.tar.gz
```
